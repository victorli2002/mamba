...
#model_dir = os.path.abspath(os.path.join(current_dir, '../mamba-ssm/models'))
...
class Trainer:
    ...
    def train(self):
        ...
        def run_epoch(split):
            ...
            for it, inputs in thing:
                outputs = inputs.clone()[1:]
                inputs = inputs[:-1]
...
if __name__ == "__main__":
    ...
    train_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "./train.pt"))
    validation_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "./dev.pt"))
